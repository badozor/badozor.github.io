...
# **![](image/Rlogo.png){width=5%} package mgmtstp27**
...
# **![](image/Rlogo.png){width=5%} package PBmisc**
Contains many functions useful for statistical analyses, data manipulation and graphic representations (**in construction**): [PBmisc](https://github.com/badozor/PBmisc)
